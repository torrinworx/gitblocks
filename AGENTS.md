...
This repository uses the GSD workflow.

- Read `.planning/PROJECT.md` before planning or execution.
- Keep `.planning/REQUIREMENTS.md` and `.planning/ROADMAP.md` in sync with phase work.
